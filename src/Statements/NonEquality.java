...
/**
 * a subclass for logical expression that checks 2 values aren't equal or not
 */

public class NonEquality extends LogicalExpresion {

    public NonEquality(String command) {
        super(command);
    }
