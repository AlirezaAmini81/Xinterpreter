...
/**
 * a subclass for logical expression that checks a value is more than or equal to another value or not
 */
public class GreaterThanOrEqual extends LogicalExpresion {

    public GreaterThanOrEqual(String command) {
        super(command);
    }
