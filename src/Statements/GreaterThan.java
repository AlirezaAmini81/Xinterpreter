...
/**
 * a subclass for logical expression that checks a value is more than another value or not
 */

public class GreaterThan extends LogicalExpresion {

    public GreaterThan(String command) {
        super(command);
    }
