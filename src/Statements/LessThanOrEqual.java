...
/**
 * a subclass for logical expression that checks a value is less than or equal to another value or not
 */

public class LessThanOrEqual extends LogicalExpresion {

    public LessThanOrEqual(String command) {
        super(command);
    }
